...
namespace DrawSystem.Views
{
    public partial class ClassPage : ContentPage
    {
        ...
        private void CheckBox_CheckedChanged(object sender, CheckedChangedEventArgs e)
        {
            ...
            if (student != null)
            {
                // Pobierz widok StackLayout dla danego ucznia
                ...
                if (stackLayout != null)
                {
                    if (e.Value)
                    {
                        // Checkbox zosta³ zaznaczony (true) - ustaw jasnoszary kolor t³a
                        stackLayout.BackgroundColor = Color.FromHex("#FFFFFF");
                    }
                    else
                    {
                        // Checkbox zosta³ odznaczony (false) - ustaw ciemnoszary kolor t³a
                        stackLayout.BackgroundColor = Color.FromRgb(169, 169, 169); // Ciemnoszary kolor
                    }
                }
            }
        }
